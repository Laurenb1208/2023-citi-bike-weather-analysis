...
- [`Final Analysis.ipynb`](Notebooks/Final%20Analysis.ipynb): Performs the final analysis, visualizations, hypothesis testing, and machine learning models to examine how weather impacts Citi Bike usage.
**Other Files:**  
